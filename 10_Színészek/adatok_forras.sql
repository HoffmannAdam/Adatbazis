INSERT INTO szineszek (nev, ferfi, szulido, szulhely, szulorsz, filmszam) VALUES
('Eastwood, Clint',1,'1930.05.31','San Francisco','USA',58),
('Funes, Louis de',1,'1914.07.31','Courbevoie','Franciaország',146),
('Davis, Bette',0,'1908.04.05','Lowell','USA',118),
('Ullmann, Liv',0,'1938.12.16','Tokió','Japán',52),
('Hepburn, Audrey',0,'1929.05.04','Brüsszel','Belgium',30),
('Kiss, Manyi',0,'1911.03.12','Zágon','Magyarország',94),
('Adjani, Isabelle',0,'1955.06.27','Párizs','Franciaország',33),
...
('Gózon, Gyula',1,'1885.3.13','Érsekújvár','Magyarország',78),
('Hayek, Salma',0,'1966.09.02','Coatzacoalcos','Mexikó',41),
...
('Montand, Yves',1,'1921.10.13','Monsummano Terme','Olaszország',60),
...
('Kerr, Deborah',0,'1921.09.30','Helensburgh','Skócia',52),
('Szõke, Szakáll',1,'1884.2.2','Budapest','Magyarország',102),
('Berry, Halle',0,'1966.08.14','Cleveland','USA',38),
('Curtis, Tony',1,'1925.06.03','Bronx','USA',131),
('Csortos, Gyula',1,'1883.3.3','Budapest','Magyarország',57),
('Kinski, Nastassja',0,'1959.01.24','Berlin','Németország',64),
('Dietrich, Marlene',0,'1901.12.27','Berlin','Németország',55),
('Redford, Robert',1,'1937.08.18','Santa Monica','USA',63),
('Howard, Leslie',1,'1893.4.3','Forest Hill','Anglia',34),
('Tognazzi, Ugo',1,'1922.03.23','Cremona','Olaszország',150),
('Garbo, Greta',0,'1905.09.18','Stockholm','Svédország',31),
('Olivier, Laurence',1,'1907.05.22','Dorking','Anglia',86),
('Gassman, Vittorio',1,'1922.09.01','Genova','Olaszország',127),
('Quinn, Anthony',1,'1915.04.21','Chihuahua','Mexikó',167),
('Pécsi, Sándor',1,'1922.03.18','Sajószentpéter','Magyarország',62),
...
('Páger, Antal',1,'1899.1.29','Makó','Magyarország',153),
('Fonda, Peter',1,'1940.02.23','New York','USA',72),
('Hopkins, Anthony',1,'1937.12.31','Margam','Wales',100),
('Bergman, Ingrid',0,'1915.08.29','Stockholm','Svédország',52),
('Moreau, Jeanne',0,'1928.01.23','Párizs','Franciaország',127),
('Basinger, Kim',0,'1953.12.08','Athens','USA',36),
('Winslet, Kate',0,'1975.10.05','Reading','Anglia',31),
('Latinovits, Zoltán',1,'1931.09.09','Budapest','Magyarország',53),
('Kline, Kevin',1,'1947.10.24','St. Louis','USA',42),
('Gobbi, Hilda',0,'1913.06.05','Budapest','Magyarország',107),
('Hawn, Goldie',0,'1945.11.21','Washington','USA',33),
('Deneuve, Catherine',0,'1943.10.22','Párizs','Franciaország',97),
...
('Delon, Alain',1,'1935.11.08','Sceaux','Franciaország',89),
...
('Jávor, Pál',1,'1902.01.31','Arad','Magyarország',72),
('Kidman, Nicole',0,'1967.06.20','Honolulu','USA',50),
('Rossellini, Isabella',0,'1952.06.18','Róma','Olaszország',54),
('Washington, Denzel',1,'1954.12.28','Mount Vernon','USA',41),
('Lancaster, Burt',1,'1913.11.02','New York','USA',88),
('Kabos, Gyula',1,'1884.3.19','Budapest','Magyarország',45),
...
('Bardot, Brigitte',0,'1934.09.28','Párizs','Franciaország',47),
('Latabár, Kálmán',1,'1902.11.24','Kecskemét','Magyarország',33),
('Ruttkai, Éva',0,'1927.12.31','Budapest','Magyarország',63),
...
('Signoret, Simone',0,'1921.03.25','Wiesbaden','Németország',71),
('Fernandel',1,'1903.05.08','Marseille','Franciaország',149),
('Lennox, Annie',0,'1954.12.25','Aberdeen','Skócia',19),
('Mastroianni, Marcello',1,'1924.09.28','Fontana Liri','Olaszország',145),
('Lopez, Jennifer',0,'1969.07.24','Bronx','USA',30),
('Philipe, Gérard',1,'1922.12.04','Cannes','Franciaország',35),
('Murray, Bill',1,'1950.09.21','Wilmette','USA',46),
('Hackman, Gene',1,'1930.01.30','San Bernardino','USA',94),
('Básti, Lajos',1,'1911.11.17','Keszthely','Magyarország',45),
('Girardot, Annie',0,'1931.10.25','Párizs','Franciaország',154),
('Chaplin, Charles',1,'1889.4.16','Walworth','Anglia',86),
('Perkins, Anthony',1,'1932.04.04','New York','USA',58),
('Costner, Kevin',1,'1955.01.18','Lynwood','USA',39),
('Bessenyei, Ferenc',1,'1919.02.10','Hódmezõvásárhely','Magyarország',75),
('Streep, Meryl',0,'1949.06.22','Summit','USA',57),
('Williams, Robin',1,'1951.07.21','Chicago','USA',80),
('Lollobrigida, Gina',0,'1927.07.04','Subiaco','Olaszország',72),
('Depardieu, Gérard',1,'1948.12.27','Châteauroux','Franciaország',155),
...
('Loren, Sophia',0,'1934.09.20','Pozzuoli','Olaszország',92),
('Szörényi, Éva',0,'1917.05.26','Budapest','Magyarország',29),
...
('Sinkovits, Imre',1,'1928.11.22','Budapest','Magyarország',84),
('Crowe, Russel',1,'1964.04.07','Wellington','Új-Zéland',33),
('Belmondo, Jean-Paul',1,'1933.04.09','Neuilly-sur-Seine','Franciaország',81),
...
('Gréco, Juliette',0,'1927.02.07','Montpellier','Franciaország',33),
('Close, Glenn',0,'1947.03.19','Greewich','USA',60),
('Sarandon, Susan',0,'1946.10.04','New York','USA',84),
('Cardinale, Claudia',0,'1938.04.15','Tunis','Tunézia',103),
('Muti, Ornella',0,'1955.03.09','Róma','Olaszország',97),
('Bogart, Humphrey',1,'1899.12.25','New York','USA',74),
('Hitchcock, Alfred',1,'1899.8.13','Leytonstone','Anglia',35);
